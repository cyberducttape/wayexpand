...
- **CLIPBOARD_INJECTION.md** - Documents clipboard-based text injection, which was
  removed from the daemon due to security concerns about silent XWayland window
  targeting
- **SECURITY_AUDIT.md** - Self-audit from the 1.0 release period
- **WLROOTS_WINDOW_TRACKER_PLAN.md** - Planning document for wlroots window
